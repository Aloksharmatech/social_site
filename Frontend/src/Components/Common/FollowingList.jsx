...
import { fetchFollowings } from "../../store/user/userFollowing-slice";
...
const FollowingList = () => {
  ...
  const { followings, loading, error } = useSelector(
  ...
  const handleFollowToggle = async (targetUserId) => {
    try {
      ...
      await dispatch(fetchFollowings(id));
